...
signal stats_changed(leaves, uncollected, happiness)
...
func _ready() -> void:
	_load_or_init()
	emit_signal("stats_changed", leaves, uncollected_leaves, happiness)
